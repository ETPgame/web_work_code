...
<%@ page import="campsg.qunawan.entity.Place, campsg.qunawan.entity.Theme, java.util.List" %>
...
<head>
	...
	<!-- PRJ-WTP-JEE-008：首页信息显示 自驾游左侧信息显示 【2/4 Start】 -->
    <%
	...
	<!-- PRJ-WTP-JEE-008：首页信息显示 自驾游左侧信息显示 【2/4 End】 -->
...
<div id="2" class="public-box" data-count-first="国内游">
	...
	<!-- PRJ-WTP-JEE-008：首页信息显示 自驾游左侧信息显示 【3/4 Start】 -->
    <!-- 公共左边导航模块开始 -->
            ...
            <div class="navigation-content">
                <center>
                    <table class="navigation-table">
                        ...
                        <tr>
                            <td align="right" width="100px"><a href="#"><%= places.get(i) %></a></td>
                            <td width="30px"></td>
                            <% if (i + 1 < places.size()) { %>
                            <td align="left" width="100px"><a href="#"><%= places.get(i + 1) %></a></td>
                            <% } else { %>
                            <td></td>
                            <% } %>
                        </tr>
            ...
            <div class="navigation-content">
                <center>
                    <table class="navigation-table">
                        ...
                        <tr>
                            <td align="right" width="100px"><a href="#"><%= themes.get(i) %></a></td>
                            <td width="30px"></td>
                            <% if (i + 1 < themes.size()) { %>
                            <td align="left" width="100px"><a href="#"><%= themes.get(i + 1) %></a></td>
                            <% } else { %>
                            <td></td>
                            <% } %>
                        </tr>
    ...
    <!-- 公共左边导航模块结束 -->
	<!-- PRJ-WTP-JEE-008：首页信息显示 自驾游左侧信息显示 【3/4 End】 -->


	<!-- PRJ-WTP-JEE-008：首页信息显示 自驾游产品信息显示 【4/4 Start】 -->
    <!-- 自由行侧边产品list -->
            ...
            <ul>
                ...
                <li>
                    <div class="pro_list_content">
                         <p>
							<img src="/image_cache/<%=trip.getMain_picname()%>" width="290" height="200" border="1">
                        </p>
                        <p onmouseover="movein(this)" onmouseout="moveout(this)">
							<span class="pro-list-price fr">
								<span>￥</span>
								<span><%= trip.getMin_price()%></span>&nbsp;起
							</span> 
							<span><%=trip.getS_title()%>></span>
                        </p>
                    </div>
                </li>
                    <%}%>
	...
	<!-- PRJ-WTP-JEE-008：首页信息显示 自驾游产品信息显示 【4/4 End】 -->

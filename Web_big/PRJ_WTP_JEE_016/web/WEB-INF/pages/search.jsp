	...
	<div class="body_bg">
		<div class="base">
			...
			<div class="navigation">
				<span class="font_g9"> 您当前所在的位置： <a href="#">首页</a> > <a
					href="#">所有路线</a> > <a href="#">${key}</a>
				</span>
			</div>
			...
			<div class="filter_box">
				...
				<div class="body">
					<div class="area option">
						...
						<dl class="ddlist">
							<dt>
								<span><a class="cur" href="#">全部</a></span>
							</dt>
							<dd>
								<span><a href="#">普吉岛 (131)</a></span> <span><a href="#">泰国
										(26)</a></span> <span><a href="#">曼谷 (131)</a></span> <span><a
									href="#">芭提雅 (26)</a></span> <span><a href="#">甲米 (131)</a></span> <span><a
									href="#">普吉 (26)</a></span> <span><a href="#">亚洲 (131)</a></span> <span><a
									href="#">清迈 (26)</a></span> <span><a href="#">香港 (131)</a></span> <span><a
									href="#">岘港 (26)</a></span> <span><a href="#">斯米兰 (131)</a></span> <span><a
									href="#">印度 (26)</a></span> <span><a href="#">新德里 (131)</a></span> <span><a
									href="#">马六甲 (26)</a></span> <span><a href="#">吉隆坡 (131)</a></span> <span><a
									href="#">马来西亚 (26)</a></span> <span><a href="#">新加坡 (131)</a></span> <span><a
									href="#">清莱 (26)</a></span> <span><a href="#">普吉岛 (131)</a></span> <span><a
									href="#">泰国 (26)</a></span> <span><a href="#">曼谷 (131)</a></span> <span><a
									href="#">芭提雅 (26)</a></span> <span><a href="#">甲米 (131)</a></span> <span><a
									href="#">普吉 (26)</a></span> <span><a href="#">亚洲 (131)</a></span> <span><a
									href="#">清迈 (26)</a></span> <span><a href="#">香港 (131)</a></span> <span><a
									href="#">岘港 (26)</a></span> <span><a href="#">斯米兰 (131)</a></span> <span><a
					...
					<div class="setout option topborder">
						...
						<dl class="ddlist">
							...
							<dd>
								<span><a href="#">成都 (131)</a></span> <span><a href="#">北京
										(26)</a></span> <span><a href="#">上海 (131)</a></span> <span><a
									href="#">无锡 (131)</a></span> <span><a href="#">杭州 (26)</a></span> <span><a
									href="#">南京 (131)</a></span> <span><a href="#">普吉 (131)</a></span> <span><a
									href="#">不限出发地 (26)</a></span> <span><a href="#">宁波 (26)</a></span> <span><a
									href="#">深圳 (131)</a></span> <span><a href="#">广州 (131)</a></span> <span><a
									href="#">重庆 (26)</a></span> <span><a href="#">长沙 (131)</a></span> <span><a
									href="#">青岛 (131)</a></span> <span><a href="#">天津 (26)</a></span> <span><a
									href="#">温州 (131)</a></span> <span><a href="#">清莱 (26)</a></span> <span><a
									href="#">成都 (131)</a></span> <span><a href="#">北京 (26)</a></span> <span><a
									href="#">上海 (131)</a></span> <span><a href="#">无锡 (131)</a></span> <span><a
									href="#">杭州 (26)</a></span> <span><a href="#">南京 (131)</a></span> <span><a
									href="#">普吉 (131)</a></span> <span><a href="#">不限出发地 (26)</a></span> <span><a
									href="#">宁波 (26)</a></span> <span><a href="#">深圳 (131)</a></span> <span><a
									href="#">广州 (131)</a></span> <span><a href="#">重庆 (26)</a></span> <span><a
									href="#">长沙 (131)</a></span> <span><a href="#">青岛 (131)</a></span> <span><a
									href="#">天津 (26)</a></span> <span><a href="#">温州 (131)</a></span> <span><a
									href="#">清莱 (26)</a></span>
							</dd>
						</dl>
						<a href="#" class="more more_y">更多<i class="arrow_down"></i></a>
					...
					<div class="theme option topborder">
						...
						<dl class="ddlist">
							...
							<dd>
								<span><a href="#">海滨岛屿 (131)</a></span> <span><a href="#">亲子
										(26)</a></span> <span><a href="#">民俗文化 (131)</a></span> <span><a
									href="#">都市观光(131)</a></span> <span><a href="#">潜水 (26)</a></span> <span><a
									href="#">游船 (131)</a></span> <span><a href="#">山水景观 (131)</a></span> <span><a
									href="#">宗教 (26)</a></span> <span><a href="#">演艺 (26)</a></span> <span><a
									href="#">美食 (131)</a></span> <span><a href="#">夜景 (131)</a></span> <span><a
									href="#">当地跟团 (26)</a></span> <span><a href="#">当地玩乐娱乐
										(131)</a></span> <span><a href="#">摄影 (131)</a></span> <span><a
									href="#">田园度假 (26)</a></span> <span><a href="#">动植物园 (131)</a></span>
								<span><a href="#">海滨岛屿 (131)</a></span> <span><a href="#">亲子
										(26)</a></span> <span><a href="#">民俗文化 (131)</a></span> <span><a
									href="#">都市观光 (131)</a></span> <span><a href="#">潜水 (26)</a></span> <span><a
									href="#">游船 (131)</a></span> <span><a href="#">山水景观 (131)</a></span> <span><a
					...
					<div class="traffic option topborder">
						...
						<dl class="ddlist">
							...
							<dd>
								<span><a href="#">飞机(131)</a></span> <span><a href="#">火车
										(26)</a></span> <span><a href="#">游轮 (131)</a></span>
							</dd>
						</dl>
						<a href="#" class="more more_y">更多<i class="arrow_down"></i></a>
						<div class="clear"></div>
					...
					<div class="days option topborder">
						...
						<dl class="ddlist">
							...
							<dd>
								<span><a href="#">1天 (131)</a></span> <span><a href="#">2天
										(26)</a></span> <span><a href="#">3天 (131)</a></span> <span><a
									href="#">4天 (26)</a></span> <span><a href="#">5天 (131)</a></span> <span><a
									href="#">6天 (26)</a></span> <span><a href="#">7天 (131)</a></span> <span><a
									href="#">14天 (26)</a></span> <span><a href="#">15天 (131)</a></span> <span><a
									href="#">21天 (26)</a></span>
							</dd>
						</dl>
						<a href="#" class="more more_y">更多<i class="arrow_down"></i></a>
					...
					<div class="border option topborder">
						...
						<dl class="ddlist">
							...
							<dd>
								<span><a href="#">国内 (131)</a></span> <span><a href="#">出境
										(26)</a></span>
							</dd>
						</dl>
						<a href="#" class="more more_y">更多<i class="arrow_down"></i></a>
				...
				<div class="tail">
					...
					<a class="condition condition_up" href="#"> 收起筛选条件 <i
						class="arrow_up"></i>
					</a> <a class="condition condition_down" href="#"> 更多筛选条件 <i
						class="arrow_down"></i>
					</a>
					<div class="clear"></div>
				</div>
				...
				<div class="main_l">
					...
					<div class="sort">
						<ul>
							...
							<li class="price" title="按价格由低到高排序"><a href="#">价格 </a><i
								class="sort_up"></i></li>
							<li class="comment" title="按好评率由高到低排序"><a href="#">好评率 </a><i
							...
							<li>
								<div>
									<input type="text" class="txt" id="price1" value=""
										...
										class="submit" href="#">确定</a>
								</div>
							</li>
						</ul>
						<div class="page">
							<p class="count_num">
								<b>${pageCurrent}</b>/${pageTotal}</p>
							<a class="prev"
								href="search.jhtml?page=${pageCurrent-1}&key=${key}"><i
					...
					<div class="recommend">
						<div class="detail">
							<a class="detail_img" href="#"> <img
								src="image_cache/${trip.main_picname}"
								width="195" height="130"><span
								class="detail_tag detail_tag_blue">${trip.type.value}</span>
							</a>
							<div class="price">
								<p class="priceTitle">去哪玩价:</p>
								<p class="priceBox">
									<span> ¥ <b>${trip.min_price}</b>
									</span> <label name="origLable">起/人</label>
								</p>
								<p class="good_comment">
									<span>${trip.good_rate}%</span>好评率
								</p>
							</div>
							<div class="detail">
								<div class="detail_list">
									<p class="detail_title">
										<span class="title_left">${trip.start.name}出发
											|</span> <a href="../tourist_detail/tourist_detail.html">${trip.title}
										</a>
									</p>
									<dl class="detail_text theme_text">
										...
										<dd>
											<p>
												<c:forEach items="${trip.themeontrip_list}" var="tot">
													${tot.theme.name},
												</c:forEach>
											</p>
										</dd>
						...
						<div class="discribe">
							<ul>
								...
								<li class="js_tips" tip-content="">
									...
									<p>
										<span>${trip.date_list[0]}</span> <span><a
											href="../tourist_detail/tourist_detail.html" class="more">更多</a></span>
									</p>
								</li>
							</ul>

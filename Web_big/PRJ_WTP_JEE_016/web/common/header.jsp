			...
			<div class="search_div">
				<div class="search_box">
					...
					<form class="form_search" id="headSearchForm"
							action="search.jhtml" method="post">
							<input type="text" id="head_search" name="key"
								value="${param.key}" class="search w_260" /> <input type="hidden"
								id="head_triptype" name="type" value="" /> <input
								type="hidden" id="head_start_place" name="city" value="" />
						</form>
					</div>

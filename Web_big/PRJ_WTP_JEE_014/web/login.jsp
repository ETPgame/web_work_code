	...
	<div class="backgrounds" id="backgrounds">
		...
		<div class="content" id="div_position">
			...
			<div class="login_framework">
				...
				<form id="log_reg_form" method="post" name="loginForm" action="/PRJ_WTP_JEE_014/login.jhtml">
					...
					<div class="content2">
						...
						<ul>
							<li><input id="tid" name="name" type="text" class="text" value="${cookie['qunawan_uid'].value}"/><br /></li>
						</ul>
						<ul id="pwd_p">

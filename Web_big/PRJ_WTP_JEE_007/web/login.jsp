	...
	<div class="backgrounds" id="backgrounds">
		...
		<div class="content" id="div_position">
			...
			<div class="login_framework">
				...
				<form id="log_reg_form" method="post" name="loginForm" action="/PRJ_WTP_JEE_007/login.jhtml">
				
					<div class="content2">
					
						<!-- PRJ-WTP-JEE-007：登陆错误提示 html转jsp 【2/2 Start】 -->
						...
						<!-- PRJ-WTP-JEE-007：登陆错误提示 html转jsp 【2/2 End】 -->
						...
						<ul id="identfy_all">
							<li>
								<span class="identifying">
									...
									onclick="this.src='code.jhtml?id='+new Date().getMilliseconds()">
									
								</span>
								<input type="text" name="code" id="ident" class="text identify" value="验证码" />
							</li>
						</ul>
						<span class="rem_password"> <a href="#" class="texts">返回首页</a>

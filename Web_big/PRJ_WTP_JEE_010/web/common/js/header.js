...
document.writeln("            <li class=\"lv_link\"><a rel=\"nofollow\" href=\"javascript:void(0);\"></a><i class=\"icon_arrow\"></i>");
document.writeln("				<div id=\"showtime\">");
document.writeln("				</div>");
document.writeln("				</li>");

document.writeln("            <li id=\"person\" class=\"dropdown\"><a rel=\"nofollow\" class=\"lv_link\" href=\"javascript:void(0);\">个人中心</a><i");
document.writeln("                    class=\"icon_arrow\"></i>");
document.writeln("				<div class=\"personlist\">");
document.writeln("					<ul class=\"p_ul\">");
document.writeln("						<li><a href=\"javascript:void(0);\">我的订单</a></li>");
document.writeln("						<li><a href=\"javascript:void(0);\">个人资料</a></li>");
document.writeln("						<li><a href=\"javascript:void(0);\">重置密码</a></li>");
document.writeln("						<li>我的优惠券</li>");
document.writeln("					</ul>");
document.writeln("				</div>");
document.writeln("				</li>");
document.writeln("            <li><a class=\"lv_link\" rel=\"nofollow\" href=\"javascript:void(0);\">积分商城</a></li>");
document.writeln("            <li><a class=\"lv_link\" rel=\"nofollow\" href=\"javascript:void(0);\">帮助</a></li>");
document.writeln("            <li class=\"dropdown\"><a rel=\"nofollow\" class=\"lv_link wx\" href=\"javascript:void(0);\"><i class=\"lv_icon icon_wx\"></i>微信 </a></li>");
document.writeln("            <li class=\"dropdown\"><a rel=\"nofollow\" class=\"lv_link wb href=\"javascript:void(0);\"><i");
document.writeln("                    class=\"lv_icon icon_wb\"></i>微博</a></li>");
document.writeln("            <li><a rel=\"nofollow\" class=\"lv_link\" href=\"javascript:void(0);\">010-12345678</a></li>");
document.writeln("        </ul>");
document.writeln("        <div class=\"topbar_login\">");
document.writeln("            <!-- 登录，注册链接 -->");
document.writeln("            <div><a href=\"javascript:void(0);\">请登录</a> | <a href=\"javascript:void(0);\">免费注册</a></div>");
document.writeln("        </div>");
...
document.writeln("						<ul>");
document.writeln("							<li class=\"item\"><span><a href=\"javascript:void(0);\">自驾游</a></span></li>");
document.writeln("							<li class=\"item\"><span><a href=\"javascript:void(0);\">国内游</a></span></li>");
document.writeln("							<li><span><a href=\"javascript:void(0);\">出境游</a></span></li>");
document.writeln("						</ul>");
document.writeln("					</div>");
document.writeln("				</div>");
...
document.writeln("								<p>");
document.writeln("									<span><a href=\"javascript:void(0);\">北京</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">上海</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">天津</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">重庆</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">桂林</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">香格里拉</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">丽江</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">乌镇</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">西塘</a></span>");
document.writeln("									<span><a href=\"javascript:void(0);\">昆明</a></span>");
document.writeln("								</p>");
document.writeln("							</li>");
document.writeln("						</ul>");
document.writeln("					</div>");
...
document.writeln("                    <form class=\"form_search\" method=\"post\" action=\"search.jhtml\">");
document.writeln("                        <input name=\"key\" type=\"text\" id=\"search\" autocomplete=\"off\" value=\"行程名称，比如千岛湖、2天等\" x-webkit-speech=\"\"");
document.writeln("                               class=\"search w_260\" num=\"0\">");
document.writeln("                       <input class=\"pointer search_button\" type=\"button\"></input>");
...
document.writeln("            <li id=\"home\"><a href=\"javascript:void(0);\"    target=\"_blank\">首页</a></li>");
document.writeln("            <li id=\"ticket\"><a href=\"javascript:void(0);\"  target=\"_blank\">自驾游<i class=\"icon_sbx\"></i></a></li>");
document.writeln("            <li id=\"liner\"><a href=\"javascript:void(0);\"   target=\"_blank\">国内游</a></li>");
document.writeln("            <li id=\"zijia\"><a href=\"javascript:void(0);\"   target=\"_blank\">出境游</a><i class=\"icon_no1\"></i></li>");
document.writeln("            <li id=\"lvyue\"><a href=\"javascript:void(0);\"   target=\"_blank\">亲子游</a><i class=\"icon_ly\"></i></li>");
document.writeln("            <li id=\"tuangou\"><a href=\"javascript:void(0);\" target=\"_blank\">特卖会</a><i class=\"icon_tg\"></i></li>");
document.writeln("            <li id=\"custom\"><a href=\"javascript:void(0);\"  target=\"_blank\">定制游</a></li>");
document.writeln("        </ul>");
document.writeln("    </div>");
document.writeln("</div>");
...
$(".search_button").click(function(){
	var key = $("#search").val();
	if(key=="行程名称，比如千岛湖、2天等")
		$("#search").val("");
	$(".form_search").submit();
});

$("#search").focus(function(e) {
	if ($("#search").val()=="行程名称，比如千岛湖、2天等"){
    	$("#search").val("");
	}
});
$("#search").blur(function(e) {
	if ($("#search").val()==""){
		$("#search").val("行程名称，比如千岛湖、2天等");
	}
});
